...
#   ./scripts/set-latest.sh ical mcp        # tag specific packages by short name
#   ./scripts/set-latest.sh --dry-run       # show what would be tagged, don't do it

ROOT="$(cd "$(dirname "$0")/.." && pwd)"

# dougpro palette (ANSI 256)
C_BLUE="\033[38;5;75m"
C_DBLUE="\033[38;5;33m"
...
ALL_PACKAGES=(core ical mcp models preact react solid)
DRY_RUN=false
MODE=""
VERSION=""
EXPLICIT=()
...
echo ""
echo -e "  ${C_GOLD}latest${C_RESET} → ${C_BOLD}${VERSION}${C_RESET}"
echo ""
